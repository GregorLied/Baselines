...
class ConcatAggregator(Aggregator):
    def __init__(self, batch_size, dim, dropout=0., activation=tf.nn.relu, name=None):
        super(ConcatAggregator, self).__init__(batch_size, dim, dropout, activation, name)
...
class NeighborAggregator(Aggregator):
    def __init__(self, batch_size, dim, dropout=0., activation=tf.nn.relu, name=None):
        super(NeighborAggregator, self).__init__(batch_size, dim, dropout, activation, name)
